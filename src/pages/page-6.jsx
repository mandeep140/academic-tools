    ...
    return (
        <div className="bg-two  py-36  text-center">
            ...
            <div className="flex gap-12 justify-center  ">
                {/* 1 */}
                <div className="w-1/5  p-6 rounded-xl shadow-xl  h-48 bg-lime-100  ">
                    <h3 className="font-semibold text-gray-800 text-lg">Tools</h3>
                    <p className="p-2 pb-8">Edit options</p>
                    <div className=""> <ContainBtn label={"Upload image"} Icon={<MdOutlineUpload className="text-2xl"/>} /> </div>
                </div>
                ...
                {/* 2 */}
                <div className="  w-1/2  py-12  px-6  rounded-xl shadow-xl bg-green-100">
                    ...
                    >
                        <div className="text-7xl txtColor-Org "> < MdCrop /> </div>
