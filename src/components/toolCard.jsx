export default function ToolCard({ title, para, icon }) {
    return (
        ...
        <div className=" w-104  h-56   bg-pink-200 rounded-xl text-center  flex flex-col">
            ...
            <span className="font-medium text-lg  mr-auto ml-8 mt-auto  mb-4  "> <a href="#"> Try it now &nbsp; -+ </a></span>
