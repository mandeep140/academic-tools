...
export default function AboutOffers() {
    ...
    return (
        ...
        <div>
            ...
            <div className=" bg-green-300 flex flex-col items-center py-16 px-4  ">

                <h3 className="text-5xl font-semibold text-gray-800 mb-8">What We Offer</h3>
            ...
            <div className=" my-16 bg-amber-200  text-center">

                <h3 className="text-5xl">  Our Team </h3>
                ...
                <div className=" bg-red-500  h-100 w-100  shadow-xl  rounded-2xl  mb-8 mx-auto  ">
                    <div className="h-32  w-32  rounded-bl-full bg-amber-300">icon</div>
                    <h3 className="text-3xl  py-8">Academic Tools Team</h3>
                ...
                <div className="h-104 w-3/4  py-4 mx-auto my-20 rounded-2xl border outline-black  bg-purple-200 shadow-xl text-center grid place-items-center">
                    <div className="h-24  w-28 rounded-2xl bg-amber-700">icon</div>
                ...
                <p className="text-xl">Built by learners, for learners ## <br />because academic life deserves better tools!</p>
