...
export default function DetailsBoxList() {
    return(
        <div  className="grid  place-items-center grid-cols-3  mx-12">
            ...
            <DetailsBox  title="Always Free"  para="Quality academic tools should be accessible to everyone. All features, completely free."  icon={ <AutoAwesomeIcon  sx={{ fontSize: 40 }} /> }  bgcolor="bg-red-100"  />
